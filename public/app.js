...
let resman2 = document.getElementById('resman');
let reslink2 = document.getElementById('reslink2');
reslink2.addEventListener('click', (e) => {
    e.preventDefault();
    resman2.scrollIntoView({
        behavior:'smooth',
        block:'start'
    })
})
